...
const seoPackageData01 = [
    {
        title: 'Starter', price: '12000/', period: 'mon', description: 'For marketing newbies and small house teams', features: [
            {
...
const seoPackageData02 = [
    {
        title: 'Basic', price: '49,999/', period: 'mon', description: 'For new but established companies seeking to grow', features: [
            {
                items: [
...
const seoPackageData03 = [
    {
        title: 'Standard', price: '30000/', period: 'mon', description: 'For those looking to grow their business/brand', features: [
            {
                items: [
                    { text: 'social media management' },
                    { text: 'planning and strategy' },
...
const seoPackageData04 = [
    {
        title: 'Premium', price: '45000/', period: 'mon', description: 'For those looking to grow their business/brand', features: [
            {
                items: [
                    { text: 'social media management' },
                    { text: 'planning and strategy' },
                ...
                <div className="half-circle bg-[#5a7ee892] w-full h-[100%] rounded-t-full">
                    <div className='w-full flex justify-center'>
                        <div className='relative top-16 w-[90%] flex justify-center gap-4'>
                            <div className='p-2 flex flex-col justify-between gap-4 rounded-xl bg-white shadow-[0px_4px_10px_-4px_rgba(0,0,0,0.3),-4px_0px_10px_-4px_rgba(0,0,0,0.3),4px_0px_10px_-4px_rgba(0,0,0,0.3)]'>
                                <div className='p-2 flex flex-col gap-4'>
                                    {seoPackageData01.map((pkg, idx) => (
                                        <React.Fragment key={idx}>
                                            ...
                                            <p className='text-center font-[18px]'>{pkg.description}</p>
                            ...
                            <div className='relative top-[-38px]'>
                                ...
                                <div className='p-2 flex flex-col gap-4 rounded-bl-xl rounded-br-xl bg-white shadow-[0,-4px_0px_10px_-4px_rgba(0,0,0,0.3),4px_0px_10px_-4px_rgba(0,0,0,0.3)]'>
                                    <div className='p-2 flex flex-col gap-4'>
                                        ...
                                        <div className='font-medium flex items-center gap-2 cursor-pointer text-blue-500'>
                                            <p>See More</p>
                                            <div>
                                                <FaAngleDown />
                                            </div>
