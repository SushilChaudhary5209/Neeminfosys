...
const services = [
  ...
  },
  {
    ...
    description:
      "From planning and coding to testing and releasing, we have a team of professionals for end-to-end software development.",
    bgColor: "#e6ebf1",
  },
  {
...
function Home() {
  ...
  return (
    <div className="relative">
      <section>
        <div className="w-full lg:px-36 md:px-10 px-2 flex flex-col lg:flex-row items-center lg:items-start gap-20">
          <div className="md:w-[50%] w-full py-12 mt-5 flex flex-col gap-8">
            <h1 className="text-5xl font-semibold flex flex-col items-center lg:items-start gap-2">
              <p>
                <span>Build Your </span>
                <span className="text-[#3779d7]">Idea’s</span>
              </p>
              <p>
                <span>Your </span>
                <span className="text-[#3779d7]">Business</span>
              </p>
              <p>
                <span>with </span>
                <span className="text-[#3779d7]">Neem </span>
                <span className="text-[#595b5d]">Infosys</span>
              </p>
            </h1>
            <div className="text-center md:text-start">
              <p className="text-xl font-normal">
                We develop user-centric websites, web apps, and digital
                marketing solutions that grow startups and existing businesses
      ...
      <section className="lg:px-36 md:px-10 px-2 relative top-52 bg-[#3474ce]">
          ...
          <div className="mx-auto p-4 flex flex-col lg:flex-row gap-6">
            {services.map((service, index) => (
              <div
                ...
                className={`bg-[${
                  service.bgColor
                }] rounded-md flex flex-col group gap-2 transition-opacity duration-300 ${
              ...
              >
                <div className="px-8 pt-8 flex items-center justify-between">
                  ...
                  <div className="w-[38px] h-[38px] relative group-hover:rotate-[360deg] transition-all duration-300 ease-in-out">
                    <IoIosArrowRoundForward
                      className="rounded-full w-full h-full bg-[#cfd1d5] 
                group-hover:bg-gradient-to-r group-hover:from-[#2641c2] 
                group-hover:to-[#3779d7] group-hover:text-white 
                group-hover:opacity-70 transform transition-all duration-300 ease-in-out"
                    />
                  </div>
                </div>
        ...
        <div className="relative bottom-20 text-white flex flex-col items-center lg:flex-row gap-12">
          <div className="w-full lg:w-[65%] px-4 flex flex-col items-center lg:items-start gap-2">
            <p className="text-[16px] font-semibold">Trusted by</p>
            <p className="text-3xl font-semibold">
              1000+ Successful Brands, We Take Charge of 6+ Services in 3+
              Industries
            </p>
          </div>
          <div className="w-full lg:w-[35%] text-3xl font-semibold flex flex-col justify-center items-center">
            <p>ICT AWARD</p>
            <p>WINNING COMPANY</p>
          </div>
        </div>
      ...
      <section>
        <div className="mt-52 lg:px-36 md:px-10 px-2 pt-12 flex justify-between">
          <div className="flex flex-col gap-2 mt-10">
            <div className="text-4xl font-bold flex flex-col gap-">
              <p>Awards &</p>
              <p>Recognition</p>
            </div>
            <div className="text-xl mt-1">
              <p>
                <span>We have won the</span> <span>𝑩𝒆𝒔𝒕 𝑺𝒕𝒂𝒓𝒕𝒖𝒑</span>{" "}
                <span> of 𝑺𝒖𝒅𝒖𝒓𝒑𝒂𝒔𝒄𝒉𝒊𝒎  </span>
              </p>
              <p>
                <span>𝑷𝒓𝒐𝒗𝒊𝒏𝒄𝒆</span> <span> from the </span>
                <span>𝑰𝑪𝑻 𝑨𝒘𝒂𝒓𝒅𝒔</span> <span>2023</span> <span>𝑵𝒆𝒑𝒂𝒍.</span>
              </p>
            </div>
          </div>
          <div className=" shadow-[0px_4px_10px_-4px_rgba(0,0,0,0.3),-4px_0px_10px_-4px_rgba(0,0,0,0.3),4px_0px_10px_-4px_rgba(0,0,0,0.3)]">
            <div className="w-[217px] h-[164px] flex justify-center items-center bg-gradient-to-r from-[#2641c2] to-[#3779d7]">
              <img src={ict_award} alt="" className="w[213px] h-[160px]" />
            </div>
            <p className="text-center font-semibold">ICT Award 2023</p>
          </div>
        </div>
        <div className="flex justify-center  pb-16 lg:px-32 mt-8">
          <img className="object-cover w-full" src={ict_award_banner_neem_infosys} alt="" />
        </div>
      </section>

      <section>
        <div className="w-full mb-12 py-8 bg-[#c9e1ee] flex flex-col items-center">
          <div className="w-full bg-[#c9e1ee] flex flex-col items-center">
            <p className="text-5xl font-semibold">Featured Projects</p>
            <p className="text-lg font-medium mt-4">
              Explore our affordable products, that help setting new standards
              to grow your business
            </p>
            <p className="text-lg font-medium">
              easing and maintaining your day to day work through excellent IT
              solutions.
            </p>
          </div>
        ...
        <div className="w-[70%] rounded-lg bg-[#dee0e5] ps-8 py-2 pe-2 flex gap-8">
          <div className="w-[60%] py-6 flex flex-col gap-8">
            <div className="text-5xl font-semibold flex flex-col gap-6">
              <p>
                {" "}
                <span className="text-[#2641c2]">Let’s Build</span>{" "}
            ...
            <div>
              <WhiteBGButton
                ...
                hoverBgColor="bg-[#444444]"
                text="Get Free Conculation"
                hoverIconBgColor="bg-[#2641c2]"
                iconBgColor="bg-[#2641c2]"
      ...
      <section className="my-12 w-full flex flex-col items-center justify-center">
        <div className="w-[70%] flex flex-col items-center justify-center gap-6">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-lg font-medium">
              We build digital solutions with the latest technologies that line
      ...
      <section className="w-full mt-24 flex justify-center">
        <div className="w-[80%] flex items-center justify-center gap-6 bg-black rounded-xl">
          <div className="w-[60%] relative text-white">
            <p className="text-3xl relative left-16 font-semibold">
              Our Robust Mobile & Web App Development Solutions Stands Your
              Business at the Top!
            </p>
            ...
            <div className="w-[50%] flex items-center gap-4 p-4 rounded-lg bg-[#e6ebf1]">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-3 font-medium">
                  ...
                  <p>
                    Top 7 Benefits of Investing in Enterprise Software
                    Development!
                  </p>
                </div>
                <div>
            ...
            <div className="w-[50%] flex items-center gap-4 p-4 rounded-lg bg-[#e8f1e9]">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-3 font-medium">
                  <p className="text-[#2641c2]">2 Feb 2024</p>
                  <p>
                    Top 10 Essential Features to Include in a Web App: A
                    Detailed Guide!
                  </p>
                </div>
                <div>
